package com.caterpillar.mvp.processor.complier;

import com.caterpillar.mvp.annotation.ExtractItf;
import com.caterpillar.mvp.annotation.MvpPresenter;
import com.caterpillar.mvp.annotation.MvpView;
import com.caterpillar.mvp.processor.complier.utils.AnnotationUtil;
import com.caterpillar.mvp.processor.complier.utils.JavaFileUtil;
import com.caterpillar.mvp.processor.complier.utils.MessagerUtil;
import com.caterpillar.mvp.processor.complier.utils.ModifierUtil;
...
@SupportedAnnotationTypes({
        "com.caterpillar.mvp.annotation.MvpView",
        "com.caterpillar.mvp.annotation.MvpPresenter",
        "com.caterpillar.mvp.annotation.ExtractItf"
})
public class CaterpillarMvpProcessor extends AbstractProcessor {
    ...
    private TypeSpec generateVItf(TypeElement element, String key) {
        ...
        ClassName superClass = ClassName.get("com.caterpillar.mvp.annotation", "CaterpillarMvpView");
    ...
    private TypeSpec generatePItf(TypeElement element, String key) {
        ...
        ClassName superClass = ClassName.get("com.caterpillar.mvp.annotation", "CaterpillarMvpPresenter");
    ...
    private TypeSpec generatePProxy(TypeElement element, String key, String pkg, TypeSpec itf, String viewProxyPkg) {
        ...
        ClassName rawReturn = ClassName.get("com.caterpillar.mvp.annotation", "CaterpillarMvpView");
