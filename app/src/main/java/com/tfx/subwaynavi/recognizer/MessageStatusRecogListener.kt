...
import com.tfx.subwaynavi.recognizer.IStatus.Companion.STATUS_FINISHED
import com.tfx.subwaynavi.recognizer.IStatus.Companion.WHAT_MESSAGE_STATUS
...
class MessageStatusRecogListener(private val handler: Handler?) : StatusRecogListener() {
    ...
    override fun onAsrFinishError(errorCode: Int, subErrorCode: Int, descMessage: String,
